...
!(function (e, t) {
  ...
  function fe(e, t, i, r) {
    var o, a, l, c;
    for (
      n.isObject(i) || ce(e, 'cannot merge mappings; the provided source object is unacceptable'),
        l = 0,
  ...
  function be(e, t) {
    ...
    for (
      ...
      0 !== i &&
      (-1 !== e.firstTabInLine &&
        ((e.position = e.firstTabInLine), ce(e, 'tab characters must not be used in indentation')),
      45 === i) &&
  ...
  function we(e, t, i, r, o) {
    ...
    if (
      ...
      r &&
        ge(e, !0, -1) &&
        ((m = !0), e.lineIndent > t ? (g = 1) : e.lineIndent === t ? (g = 0) : e.lineIndent < t && (g = -1)),
      1 === g)
    )
      for (; Ae(e) || ve(e); )
        ge(e, !0, -1)
    ...
    if (
                ...
                (function (e, t, n) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      63 === s
                        ? (y && (de(e, f, d, h, g, null, a, l, c), (h = g = m = null)), (b = !0), (y = !0), (r = !0))
                        : y
                          ? ((y = !1), (r = !0))
                          : ce(
                              e,
                    ...
                    if (
                      ((e.line === o || e.lineIndent > t) &&
                        ...
                        y || (de(e, f, d, h, g, m, a, l, c), (h = g = m = null)),
                        ge(e, !0, -1),
            ...
            (function (e, t) {
              ...
              for (null !== e.anchor && (e.anchorMap[e.anchor] = o), d = e.input.charCodeAt(++e.position); 0 !== d; ) {
                if ((ge(e, !0, t), (d = e.input.charCodeAt(e.position)) === a))
                  return (
                    e.position++, (e.tag = g), (e.anchor = m), (e.kind = s ? 'mapping' : 'sequence'), (e.result = o), !0
                  );
                h
                ...
                (function (e, t) {
                  ...
                  for (e.kind = 'scalar', e.result = ''; 0 !== a; )
                    if (43 === (a = e.input.charCodeAt(++e.position)) || 45 === a)
                      ...
                      0 === o
                        ? ce(e, 'bad explicit indentation width of a block scalar; it cannot be less than one')
                        : u
                  ...
                  for (; 0 !== a; ) {
                    for (
                      he(e), e.lineIndent = 0, a = e.input.charCodeAt(e.position);
              ...
              (function (e, t) {
                ...
                for (
                  ...
                  if (39 === n) {
                    ...
                    J(n)
                      ? (pe(e, i, r, !0), ye(e, ge(e, !1, t)), (i = r = e.position))
                      : e.position === e.lineStart && me(e)
                        ? ce(e, 'unexpected end of the document within a single quoted scalar')
              ...
              (function (e, t) {
                ...
                for (
                  ...
                  if (92 === l) {
                    ...
                    J(l)
                      ? (pe(e, n, i, !0), ye(e, ge(e, !1, t)), (n = i = e.position))
                      : e.position === e.lineStart && me(e)
                        ? ce(e, 'unexpected end of the document within a double quoted scalar')
                ...
                : !(function (e) {
                      ...
                      for (i = e.input.charCodeAt(++e.position), t = e.position; 0 !== i && !z(i) && !X(i); )
                        i = e.input.charCodeAt(++e.position);
                      return (
                        e.position === t && ce(e, 'name of an alias node must contain at least one character'),
                  ...
                  ? (function (e, t, n) {
                      ...
                      for (e.kind = 'scalar', e.result = '', r = o = e.position, a = !1; 0 !== u; ) {
                        if (58 === u) {
                          ...
                          if (J(u)) {
                            if (
                              ((l = e.line), (c = e.lineStart), (s = e.lineIndent), ge(e, !1, -1), e.lineIndent >= t)
                            ) {
      ...
      for (
        null !== e.result &&
          'scalar' !== e.kind &&
          ce(e, 'unacceptable node kind for !<?> tag; it should be "scalar", not "' + e.kind + '"'),
          s = 0,
      ...
      f || ce(e, 'unknown tag !<' + e.tag + '>'),
        null !== e.result &&
          f.kind !== e.kind &&
          ce(e, 'unacceptable node kind for !<' + e.tag + '> tag; it should be "' + f.kind + '", not "' + e.kind + '"'),
  ...
  function ke(e) {
    ...
    ge(e, !0, -1),
      ...
      e.position === e.lineStart && me(e)
        ...
        : e.position < e.length - 1 && ce(e, 'end of the stream or a document separator is expected');
  }
  function Ce(e, t) {
    (t = t || {}),
      0 !== (e = String(e)).length &&
    ...
    var n = new ae(e, t),
      i = e.indexOf('\0');
    for (
      -1 !== i && ((n.position = i), ce(n, 'null byte is not allowed in input')), n.input += '\0';
  ...
  function qe(e, t, n) {
    var i = Ue(e),
      r = i && !_e(e);
    return (
      ((n ? i : i && 44 !== e && 91 !== e && 93 !== e && 123 !== e && 125 !== e) && 35 !== e && !(58 === t && !r)) ||
      (Ue(t) && !_e(t) && 35 === e) ||
      (58 === t && r)
    );
  }
  ...
  function $e(e, t, n, i) {
    ...
    for (r = 0, o = n.length; r < o; r += 1)
      (a = n[r]),
        ...
        (Ve(e, t + 1, a, !0, !0, !1, !0) || (void 0 === a && Ve(e, t + 1, null, !0, !0, !1, !0))) &&
          ((i && '' === l) || (l += Le(e, t)),
  ...
  function Ge(e, t, n) {
    ...
    for (a = 0, l = (r = n ? e.explicitTypes : e.implicitTypes).length; a < l; a += 1)
      if (
        ...
        if (
          (n ? (c.multi && c.representName ? (e.tag = c.representName(t)) : (e.tag = c.tag)) : (e.tag = '?'),
          c.represent)
        ) {
  ...
  function Ve(e, t, n, i, r, a, l) {
    ...
    if (
      ...
      if ((d && f && !e.usedDuplicates[p] && (e.usedDuplicates[p] = !0), '[object Object]' === s))
              ...
              for (r = 0, a = d.length; r < a; r += 1)
                (u = ''),
                  ...
                  Ve(e, t + 1, l, !0, !0, !0) &&
                    ...
                    s && (u += Le(e, t)),
                    Ve(e, t + 1, c, !0, s) &&
                      (e.dump && 10 === e.dump.charCodeAt(0) ? (u += ':') : (u += ': '), (p += u += e.dump)));
              (e.tag = f), (e.dump = p || '{}');
            })(e, t, e.dump, r),
        ...
        i && 0 !== e.dump.length
          ? (e.noArrayIndent && !l && t > 0 ? $e(e, t - 1, e.dump, r) : $e(e, t, e.dump, r),
            f && (e.dump = '&ref_' + p + e.dump))
          : (!(function (e, t, n) {
              var i,
                r,
              ...
              for (i = 0, r = n.length; i < r; i += 1)
                (o = n[i]),
                  ...
                  (Ve(e, t, o, !1, !1) || (void 0 === o && Ve(e, t, null, !1, !1))) &&
      ...
      null !== e.tag &&
        ...
        (c =
          '!' === e.tag[0] ? '!' + c : 'tag:yaml.org,2002:' === c.slice(0, 18) ? '!!' + c.slice(18) : '!<' + c + '>'),
        (e.dump = c + ' ' + e.dump));
    }
    return !0;
  }
  ...
  function Je(e, t, n) {
    ...
    if (null !== e && 'object' == typeof e)
      ...
      else if ((t.push(e), Array.isArray(e))) for (r = 0, o = e.length; r < o; r += 1) Je(e[r], t, n);
  ...
  var ze = p,
    ...
    at = {
      dump: function (e, t) {
        ...
        n.noRefs || Ze(e, n);
        var i = e;
        return n.replacer && (i = n.replacer.call({ '': i }, '', i)), Ve(n, 0, i, !0, !0) ? n.dump + '\n' : '';
      }
    }.dump,
    lt = o,
    ct = {
